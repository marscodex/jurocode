...
================================================== -->
  <body>
    ...
    <br><br><br><br><br><br>
      ...
      <div class="row">
        <div class="col-lg-4">
          <h1 style="color:#ADFF2F;margin-left:00px;font-size: 40px;">Mission</h1>
          <h1 style="color:#FFE4E1;margin-left:00px;border: 2px #FFE4E1;border-radius: 5px;">To spread the good news of the Bible to the needy community, 
            spiritual, physical and those suffering from social distress. </h1>
        </div>
          <div class="col-lg-8">
            <img src="<?php echo base_url(); ?>images/sddefault.jpg">
          </div>
        </div>
      </div>
