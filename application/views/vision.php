...
================================================== -->
  <body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo base_url();?>click_here_to_contact_us">Contact</a></li><br>
    ...
    <br><br><br><br><br><br>
      ...
      <div class="row">
        <div class="col-lg-4">
          <h1 style="color:#ADFF2F;margin-left:00px;font-size: 40px;">Vision</h1>
          <h1 style="color:#FFE4E1;margin-left:00px;border: 2px #FFE4E1;border-radius: 5px;">The life saver missionaries having realised the need will 
            provide and give a hand to support the vulnerable, widows, orphans, street children 
            and sick to their health and social wellbeing.</h1>
        </div>
          <div class="col-lg-8">
            <img src="<?php echo base_url(); ?>images/children-2143808__480.jpg">
          </div>
        </div>
      </div>
